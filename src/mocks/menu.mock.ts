...
export const mockMenuData: MenuData = {
  ...
  categories: [
    ...
    },
    {
      ...
      products: [
        {
          id: 'combo-classic-fritas',
          name: 'Combo Classic',
          description: 'Classic Burger + fritas médias + refrigerante lata.',
          imageUrl: img('photo-1513104890138-7c749659a591'),
          basePrice: 39.9,
          promoPrice: 36.9,
          variations: [],
        ...
        {
          id: 'combo-smash-fritas',
          name: 'Combo Smash',
          description: 'Smash House + fritas + bebida 350ml.',
          imageUrl: img('photo-1550547660-d9450f859349'),
          basePrice: 34.9,
          promoPrice: null,
          variations: [],
    ...
    },
    {
      ...
      products: [
        {
          id: 'fritas-tradicional',
          name: 'Batata Frita Tradicional',
          description: 'Porção crocante de batata frita com sal da casa.',
      ...
      products: [
        {
          ...
          description: 'Pão, salsicha, molho, milho, batata palha e maionese.',
          imageUrl: img('photo-1612392062798-7fb73b7e2a0a'),
          basePrice: 14.9,
          promoPrice: null,
          variations: [],
          addons: [],
        },
        {
          id: 'hot-dog-duplo',
          name: 'Hot Dog Duplo',
          description: 'Duas salsichas, molho especial, queijo e batata palha.',
          imageUrl: img('photo-1606755962773-d324e9a13086'),
          basePrice: 19.9,
          promoPrice: 17.9,
          variations: [],
          addons: [],
      ...
      products: [
        {
          ...
          description: 'Brownie quentinho servido com bola de sorvete.',
        ...
        {
          id: 'churros-doce-leite',
          name: 'Churros com Doce de Leite',
          description: 'Porção de mini churros polvilhados com açúcar e canela.',
    ...
    },
    {
      ...
      products: [
        ...
        },
        {
          ...
          description: 'Milkshake artesanal de morango 500ml.',
          imageUrl: img('photo-1553787499-6f913324e0b0'),
          basePrice: 17.9,
          promoPrice: null,
          variations: [],
          addons: [],
