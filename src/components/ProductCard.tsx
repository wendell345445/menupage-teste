...
export function ProductCard({ product, onNavigate }: Props) {
  ...
  return (
    <article
      ...
      className="relative min-h-[122px] w-full cursor-pointer rounded-[14px] border border-menu-card-border bg-white p-3 pr-[136px] shadow-[0_4px_16px_rgba(0,0,0,0.08)] transition-transform active:scale-[0.99]"
    ...
    >
      ...
      <div className="absolute bottom-[12px] right-[10px] top-[12px] w-[116px] overflow-hidden rounded-[12px] bg-[#f3eeee]">
        {product.imageUrl ? (
          <>
